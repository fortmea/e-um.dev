...
CREATE OR REPLACE FUNCTION "public"."decrement_stats_counter"() RETURNS "trigger"
...
ALTER FUNCTION "public"."decrement_stats_counter"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_record_count"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_record_count"() OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "decrement_stats_trigger" AFTER DELETE ON "public"."records" FOR EACH ROW EXECUTE FUNCTION "public"."decrement_stats_counter"();
...
CREATE OR REPLACE TRIGGER "update_record_stats" AFTER INSERT ON "public"."records" FOR EACH ROW EXECUTE FUNCTION "public"."update_record_count"();
...
CREATE POLICY "Allow read to all" ON "public"."stats" FOR SELECT USING (true);
...
GRANT ALL ON FUNCTION "public"."decrement_stats_counter"() TO "anon";
GRANT ALL ON FUNCTION "public"."decrement_stats_counter"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."decrement_stats_counter"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_record_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_record_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_record_count"() TO "service_role";
